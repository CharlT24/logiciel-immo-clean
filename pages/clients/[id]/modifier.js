...
export default function ModifierClient() {
  ...
  const fetchClient = async () => {
    ...
    else alert("Erreur chargement client")
  }
  ...
  if (!form.nom) return <p className="text-center mt-10">Chargement du client...</p>

  return (
    <div className="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow space-y-8">
      <h1 className="text-2xl font-bold text-orange-600">✏️ Modifier le client</h1>
